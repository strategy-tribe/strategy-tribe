    ...
    <div className="mx-auto max-w-4xl space-y-8">
      ...
      <ReadingSection>
        <p>
          ...
          and crowdfunding OSINT locating the cryptowallets of threat actors. We
          reserve the right to sanction or expel any member or contributor at
          any time.
        </p>
        <p>
          ...
          ‘proposals’. Bounties are curated at the discretion of Strategy Tribe
          to only include entities, individuals or groups currently under
          sanction or to aid in the progress of public safety and good. Staff
          members review submissions based on the evidence provided alongside
          it. Once a submission is marked as accepted, the funds in the bounty’s
          wallet gets transferred to the user’s wallet..
        </p>
      </ReadingSection>
      <ReadingSection title="Focus & Mission">
        <p>
          ...
          this reason we do not tolerate any discrimination, abuse or political
          debate on our channels.
        </p>
      </ReadingSection>
      ...
      <ReadingSection title="Submitting Findings">
        ...
        <p>
          Be mindful that StrategyTribe does not guarantee all submissions will
          be reviewed. Bounties and their rewards are awarded on a “first come,
          first served” basis; someone might have submitted their findings
          before you and therefore be reviewed and awarded the reward first.
        </p>
      ...
      <ReadingSection title="Judging">
        <p>
          The judging criteria for bounties are the same regardless of the type
          of bounty you have chosen to pursue.
        </p>

        <p>
          When reflecting on whether your submission meets the minimum standard
        ...
        <div className="py-2">
          <ul className="space-y-5">
            ...
            <li>
              <h5>
                Can StrategyTribe easily replicate the links you have made? (The
                connection between the bounty and your submission must be solid
                and clear).
              </h5>
              <p className="ml-2">
                In order to ensure your information is trustworthy, our staff
                must be able to reach the same conclusion following the same
                steps as you. You can submit screenshots of your process or even
        ...
        <p>
          ...
          fields are complete and that there is enough evidence for the staff to
          replicate your steps and arrive at the same conclusion.
        </p>
      </ReadingSection>
      ...
      <ReadingSection title="Community Rules">
        <p>
          ...
          StrategyTribe condemns any form of crime and theft of data, therefore,
          it is reinforced that you must have full ownership of your findings.
          StrategyTribe reserves the right to sanction or expel any member at
          any time if our code of conduct is not respected.
        </p>
      </ReadingSection>
      ...
      <ReadingSection>
        <p>
          ...
          participation in the Project. Ongoing permission to contribute to the
          Project is contingent upon researchers’ adherence to the Agreement.
        </p>
      </ReadingSection>
        ...
        <table className="border-separate border-spacing-0 border border-surface text-left">
          ...
          <tbody>
            ...
            <tr className="[&>*]:body [&>*]:border-[0.5px] [&>*]:border-surface [&>*]:p-2">
              <th>Good Standing</th>
              <th>
                The situation of remaining in compliance with this Agreement and
                in particularly the Code of Conduct for Researchers set out
                below
              </th>
            </tr>
            <tr className="[&>*]:body [&>*]:border-[0.5px] [&>*]:border-surface [&>*]:p-2">
              <th>Platform</th>
              <th>
                The cryptowallet identification service operated by the Project.
              </th>
            </tr>
            <tr className="[&>*]:body [&>*]:border-[0.5px] [&>*]:border-surface [&>*]:p-2">
              <th>Project</th>
            ...
            <tr className="[&>*]:body [&>*]:border-[0.5px] [&>*]:border-surface [&>*]:p-2">
              ...
              <th>
                ...
                concerning the identity of cryptowallet owners, or threat actor
                information with attached criteria for Findings.
              </th>
            </tr>
            <tr className="[&>*]:body [&>*]:border-[0.5px] [&>*]:border-surface [&>*]:p-2">
              <th>Researcher</th>
            ...
            <tr className="[&>*]:body [&>*]:border-[0.5px] [&>*]:border-surface [&>*]:p-2">
              <th>Verification</th>
              <th>
                The process whereby Project staff review a Finding to confirm it
                meets the associated Proposal’s criteria.
              </th>
            </tr>
          </tbody>
        </table>
      ...
      <ReadingSection title="Agreement" spacing="space-y-8">
        <div className="space-y-6">
          ...
          <p>
            ...
            working days arrange to make payment of the associated Bounty to the
            finding Researcher’s registered cryptowallet.
          </p>
          ...
          <p>
            The Project reserves the right to may changes to all or any part of
            the Platform, in the interests of continuous service improvement.
          </p>

          <p>
            The Project reserves the right to withdraw the Platform at any time,
            for any reason.
          </p>

          <p>
            The Project reserves the right to terminate a Researcher’s access to
            the Platform at any time, for any reason. Researchers acknowledge
            that in the interests of individual and nation security, the Project
            will not always be able to give reasons for this termination.
          </p>
        </div>
        ...
        <div className="space-y-6">
          <h3>Researchers</h3>
          <p>
            Researchers confirm that they are over the age of 18. Persons under
            the age of 18 are ineligible to participate in the Project.
          </p>
          <p>
          ...
          <p>
            ...
            Researchers are thus solely responsible to account for income tax in
            their relevant jurisdictions in relation to any Bounty payment
            received.
          </p>
          <p>
            In their independent capacity, Researchers bear sole responsibility
            for the information submitted in a Finding and for any expenses
            incurred in the course of preparing a Finding.
          </p>
          <p>
        ...
        <div className="space-y-6">
          ...
          <p>
            By submitting a Finding, Researchers confirm release of any and all
            claims of intellectual property rights associated to the contents of
            the Finding to the Project.
          </p>
          <p>
            If a question of national security interests arises, notwithstanding
            payment of a Bounty, the Project reserves the right not to release
            the Finding publicly.
          </p>
        </div>
        ...
        <div className="space-y-6">
          ...
          <ul className="list-disc space-y-2">
            ...
            <li>
              ...
              prior to payment of any Bounty related to the associated Proposal.
            </li>
            <li>
            ...
            <li>
              Not pursue, harass, threaten, or extort any person or organisation
              who is or may be the subject of a Proposal or Finding.
            </li>
          </ul>
        </div>
        ...
        <div className="space-y-6">
          ...
          <p>
            ...
            EXPLICITLY DISCLAIMS ANY WARRANTIES OF MERCHANTABILITY, FITNESS FOR
            A PARTICULAR PURPOSE OR NON-INFRINGEMENT, AND ANY WARRANTIES ARISING
            OUT OF COURSE OF DEALING, CUSTOM, OR USAGE OF TRADE. The Project
            makes no warranty that the Platform will meet a Researcher’s
            specific requirements or be available on an uninterrupted, secure,
            or error-free basis.
          </p>
        </div>
        <div className="space-y-6">
          <h3>Indemnity</h3>
          <p>
            The Researcher indemnifies the Project and its officers, directors,
            employees, and agents, from and against any claims, disputes,
            demands, liabilities, damages, losses, and costs and expenses,
            including, without limitation, reasonable legal and accounting fees
            arising out of a third party claim that the Researcher’s Finding
            infringes upon a patent, copyright, trademark, or trade secret of a
            third party, or arising from the Researcher’s use of the Platform in
        ...
        <div className="space-y-6">
          ...
          <p>
            This Agreement will commence upon registration with the Project and
            will continue until terminated by either party in accordance with
            ...
            Defaulting Party) if the Defaulting Party has materially breached a
            provision of this Agreement, and that breach subsists for thirty
